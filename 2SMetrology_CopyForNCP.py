...
#file_list = glob.glob(r"C:\Users\17152\Documents\Research\Metrology\SA1902\*.TXT") ## Change here
...
#    print('top copy sensor == ',top_copy)
    ...
    bot_needle_rottrans = np.array(fit(bot_needle,bot_needle,delta_cm,r.rotation))          #Bottom needles with rotation and translation from needle fit
    print ('cm bot ==', cm(bot_needle))
    print ('cm top ==', cm(top_needle))
    print ('translation needle ==', delta_cm)
    print(bot_needle_rottrans)
    print()
